...
const callbackQueue = new Queue(queueNames.callback, { connection: redis });
new Queue(queueNames.webhook, { connection: redis });
new Queue(queueNames.reconcile, { connection: redis });
new Queue(queueNames.async, { connection: redis });
